...
const { createAssignment, listAssignments, listAssignmentsByCourse, getAssignment } = require("../controllers/assignmentController");
...
router.get("/", requireAuth, (req, res, next) => Promise.resolve(listAssignments(req, res)).catch(next));
