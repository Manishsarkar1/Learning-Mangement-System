...
router.post("/create", requireAuth, requireRole(["instructor", "admin"]), (req, res, next) =>
  Promise.resolve(createCourse(req, res)).catch(next)
);
...
router.post("/:courseId/materials", requireAuth, requireRole(["instructor", "admin"]), (req, res, next) =>
